...
,	swapPanes = function (evt_or_pane1, pane2) {
	...
	/**
	* INTERNAL method to _sync pin-buttons when pane is opened or closed
...
,	addPin: function (inst, selector, pane) {
		...
		if ($E.length) {
			...
			// add this pin to the pane data so we can '_sync it' automatically
...
,	setPinState: function (inst, $Pin, pane, doPin) {
	...
	/**
	* INTERNAL function to _sync 'pin buttons' when pane is opened or closed
	* Unpinned means the pane is 'sliding' - ie, over-top of the adjacent panes
	*
	* @see  open(), close()
	*
